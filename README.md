...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/zenoh-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/zenoh-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add zenoh zenoh-plugin-rest zenoh-plugin-storage-manager zenoh-rust-abi zenohd
# for installing globally
pixi global install zenoh zenoh-plugin-rest zenoh-plugin-storage-manager zenoh-rust-abi zenohd
```
...
It is possible to list all of the versions of `zenoh` available on your platform:
...
```
pixi search zenoh --channel conda-forge
```
